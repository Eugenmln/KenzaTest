...
export const productType = defineType({
  ...
  fields: [
    ...
    defineField({ name: 'category', title: 'Categoría', type: 'string', options: { list: ['Remeras','Camisas','Chombas','Shorts','Pantalones','Accesorios','Otros'] }, validation: (Rule) => Rule.required() }),
    ...
    defineField({ name: 'images', title: 'Fotos', type: 'array', of: [{ type: 'image', options: { hotspot: true } }], validation: (Rule) => Rule.min(1) }),
